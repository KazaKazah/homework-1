...
# # Задание 2
# Создайте класс с несколькими методами для этих объектов, создайте массив таких объектов. Создайте ещё один метод,
#  который будет сохранять этот объект в файл.
